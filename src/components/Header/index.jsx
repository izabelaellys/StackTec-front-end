...
const Header = () => {
  ...
  return (
    <StyledHeader index={nome ? 1 : 0}>
      ...
      <form className="caixa-pesquisa" onSubmit={(e) => makeSearchPost(e)}>
        <input type="text"
          placeholder="O que você está buscando?"
          value={searchTerm}
          onChange={(e) => SetSearchTerm(e.target.value)}
        />
          <span className="search-icon"><svg className="svgIcon-use" width="30" height="40" viewbox="0 -5 28 15" onClick={(e) => makeSearchPost(e)}>
            <path
